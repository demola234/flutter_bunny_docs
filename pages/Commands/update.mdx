...
```
Flutter Bunny is already at the latest version: 1.0.6-beta.9
...
```
Updating Flutter Bunny from 1.0.6-beta.4 to 1.0.6-beta.9...
Flutter Bunny updated to 1.0.6-beta.9
...
```
A new version of Flutter Bunny is available: 1.0.6-beta.9 (current: 1.0.6-beta.9)
