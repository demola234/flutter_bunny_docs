...
```
Flutter Bunny is already at the latest version: 1.1.1
...
```
Updating Flutter Bunny from 1.1.1 to 1.0.4
Flutter Bunny updated to 1.1.1
...
```
A new version of Flutter Bunny is available: 1.1.1(current: 1.1.1)
