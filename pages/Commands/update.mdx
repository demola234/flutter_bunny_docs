...
```
Flutter Bunny is already at the latest version: 1.0.6-beta.5
...
```
Updating Flutter Bunny from 1.0.6-beta.4 to 1.0.6-beta.5...
Flutter Bunny updated to 1.0.6-beta.5
...
```
A new version of Flutter Bunny is available: 1.0.6-beta.5 (current: 1.0.6-beta.4)
