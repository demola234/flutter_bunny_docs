...
```
Updating Flutter Bunny from 1.0.7-beta.9 to 1.0.7-beta.6...
Flutter Bunny updated to 1.0.7-beta.6
...
```
A new version of Flutter Bunny is available: 1.0.7-beta.6 (current: 1.0.7-beta.6)
